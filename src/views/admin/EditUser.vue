...
async function handleSave() {
  ...
  try {
    ...
    if (err?.response?.status === 400) {
      if (err?.response?.data?.message === 'User sudah terdaftar') {
        ...
        <div class="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title">
          ...
          <div class="modal-body">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                <input v-model="confirmPassword" :type="showConfirm ? 'text' : 'password'" placeholder="Ulangi password baru" class="field-input field-input--icon-right" :class="{ 'field-input--error': errors.confirmPassword }" @input="delete errors.confirmPassword" />
