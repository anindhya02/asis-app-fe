...
async function fetchData(page = 0) {
  await store.fetchExpenseTransactions({
  ...
  <div class="layout">
    ...
    <main class="content">
      ...
      <section class="table-card">
        ...
        <footer v-if="store.totalElements > 0" class="table-footer">
...
.data-row:hover { background-color: #f0fdfb; }

.th-right  { text-align: right; }
.th-center { text-align: center; }
.td-amount { text-align: right; font-weight: 600; }
.td-muted  { color: #525252; }
